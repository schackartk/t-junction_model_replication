...
The equation for $A_{droplet}$ is given by:

$$
A_{droplet} = 
    \begin{cases}
      \frac{1}{4}{\pi}w^2 + \frac{1}{2}{\pi}\left(\frac{w}{2}\right)^2 & \quad \text{for } w_{in} \leq w\\
      \frac{\pi}{2}\left(\frac{w}{2}\right)^2 + \frac{\pi}{4}w_{in}^2 \\
...
The equation for $l_{gutter}$ is given by:

$$
l_{gutter} = 
    \begin{cases}
      \frac{1}{4}2{\pi}w + \frac{1}{2}2{\pi}\frac{w}{2} & \quad \text{for } w_{in} \leq w\\
      \frac{w\pi}{2}+w_{in}\left(\frac{\pi}{2}-\arcsin\left(1-\frac{w}{w_{in}}\right)\right) & \quad \text{for } w_{in} > w
    \end{cases}
$$
...
Therefore $R$ can be evaluated as a function of time (taking the positive of the square root), and
